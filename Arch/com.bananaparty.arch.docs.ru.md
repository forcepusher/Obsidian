...
- Объекты должны быть самодостаточными. По завершению исполнения конструктора, у них должны быть все необходимые данные для исполнения своей задачи (в случае Unity конструктор это инспектор и Awake).
