...
- Объекты должны следовать принципу единственной ответственности, это не просто так первая буква в SOLID. А так же быть самодостаточными. По завершению исполнения конструктора, у объекта должны быть все необходимые данные и ссылки для исполнения своей задачи (в случае Unity конструктор это референсы инспектора и Awake).
